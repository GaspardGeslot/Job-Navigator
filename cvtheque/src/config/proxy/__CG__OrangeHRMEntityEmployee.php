...
class Employee extends \OrangeHRM\Entity\Employee implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'empNumber', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'employeeId', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'profileId', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'courseStart', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'studyLevel', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'salary', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'drivingLicense', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'motivation', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'need', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'resume', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'attachment', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'jobs', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'roles', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'emp_skills', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companyName', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companySiret', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companyWorkforce', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companyNafCode', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companyWebsite', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companyPresentation', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companyLogo', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companyId', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companyLocation', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companyPhoneNumberContact', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companyEmailContact', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companyMatchingJobTitle', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'matchingId', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companyAllowContactViaEmail', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'companyAllowContactViaPhone', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'candidatureStatus', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'lastName', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'firstName', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'middleName', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'nickName', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'smoker', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'ethnicRaceCode', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'birthday', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'nationality', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'gender', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'maritalStatus', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'ssnNumber', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'sinNumber', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'otherId', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'drivingLicenseNo', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'drivingLicenseExpiredDate', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'militaryService', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'empStatus', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'jobTitle', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'jobCategory', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'subDivision', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'street1', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'street2', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'city', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'country', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'province', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'zipcode', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'mobility', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'homeTelephone', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'mobile', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'workTelephone', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'workEmail', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'salaryGradeCode', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'joinedDate', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'otherEmail', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'employeeTerminationRecord', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'custom1', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'custom2', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'custom3', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'custom4', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'custom5', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'custom6', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'custom7', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'custom8', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'custom9', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'custom10', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'purgedAt', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'locations', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'dependents', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'emergencyContacts', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'immigrationRecords', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'workExperience', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'educations', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'skills', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'languages', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'licenses', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'memberships', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'salaries', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'employmentContracts', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'attachments', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'employeeTerminationRecords', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'users', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'empPicture', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'subordinates', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'supervisors', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'empUsTax', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'employeeWorkShift', '' . "\0" . 'OrangeHRM\\Entity\\Employee' . "\0" . 'attendanceRecords', 'entityDecorator'];
        }
    ...
    public function setCompanyContact(mixed $companyContact): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompanyContact', [$companyContact]);

        parent::setCompanyContact($companyContact);
    }
    ...
    public function setCompanyDetails(mixed $company): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompanyDetails', [$company]);

        parent::setCompanyDetails($company);
    }
    ...
    public function getEmpSkills(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEmpSkills', []);

        return parent::getEmpSkills();
    }
    ...
    public function setEmpSkills(string $emp_skills): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEmpSkills', [$emp_skills]);

        parent::setEmpSkills($emp_skills);
    }
    ...
    public function getCompanySiret(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompanySiret', []);

        return parent::getCompanySiret();
    }
    ...
    public function setCompanySiret(string $companySiret): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompanySiret', [$companySiret]);

        parent::setCompanySiret($companySiret);
    }
    ...
    public function getCompanyPresentation(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompanyPresentation', []);

        return parent::getCompanyPresentation();
    }
    ...
    public function setCompanyPresentation(string $companyPresentation): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompanyPresentation', [$companyPresentation]);

        parent::setCompanyPresentation($companyPresentation);
    }
    ...
    public function getCompanyWebsite(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompanyWebsite', []);
    ...
    public function setCompanyWebsite(string $companyWebsite): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompanyWebsite', [$companyWebsite]);

        parent::setCompanyWebsite($companyWebsite);
    }
    ...
    public function getCompanyWorkforce(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompanyWorkforce', []);

        return parent::getCompanyWorkforce();
    }
    ...
    public function setCompanyWorkforce(string $companyWorkforce): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompanyWorkforce', [$companyWorkforce]);

        parent::setCompanyWorkforce($companyWorkforce);
    }
    ...
    public function getCompanyNafCode(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompanyNafCode', []);

        return parent::getCompanyNafCode();
    }
    ...
    public function setCompanyNafCode(string $companyNafCode): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompanyNafCode', [$companyNafCode]);

        parent::setCompanyNafCode($companyNafCode);
    }
    ...
    public function setCompanyLogo(string $companyLogo): void
    {
        ...
        parent::setCompanyLogo($companyLogo);
    }
    ...
    public function getCompanyLocation(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompanyLocation', []);
    ...
    public function setCompanyLocation(string $companyLocation): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompanyLocation', [$companyLocation]);

        parent::setCompanyLocation($companyLocation);
    }
    ...
    public function getCompanyPhoneNumberContact(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompanyPhoneNumberContact', []);

        return parent::getCompanyPhoneNumberContact();
    }
    ...
    public function setCompanyPhoneNumberContact(string $companyPhoneNumberContact): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompanyPhoneNumberContact', [$companyPhoneNumberContact]);

        parent::setCompanyPhoneNumberContact($companyPhoneNumberContact);
    }
    ...
    public function getCompanyEmailContact(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompanyEmailContact', []);

        return parent::getCompanyEmailContact();
    }
    ...
    public function setCompanyEmailContact(string $companyEmailContact): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompanyEmailContact', [$companyEmailContact]);

        parent::setCompanyEmailContact($companyEmailContact);
    }
    ...
    public function getCompanyMatchingJobTitle(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompanyMatchingJobTitle', []);

        return parent::getCompanyMatchingJobTitle();
    }
    ...
    public function setCompanyMatchingJobTitle(string $companyMatchingJobTitle): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompanyMatchingJobTitle', [$companyMatchingJobTitle]);

        parent::setCompanyMatchingJobTitle($companyMatchingJobTitle);
    }
    ...
    public function getCompanyAllowContactViaEmail(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompanyAllowContactViaEmail', []);

        return parent::getCompanyAllowContactViaEmail();
    }
    ...
    public function setCompanyAllowContactViaEmail(bool $companyAllowContactViaEmail): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompanyAllowContactViaEmail', [$companyAllowContactViaEmail]);

        parent::setCompanyAllowContactViaEmail($companyAllowContactViaEmail);
    }
    ...
    public function getCompanyAllowContactViaPhone(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompanyAllowContactViaPhone', []);

        return parent::getCompanyAllowContactViaPhone();
    }
    ...
    public function setCompanyAllowContactViaPhone(bool $companyAllowContactViaPhone): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompanyAllowContactViaPhone', [$companyAllowContactViaPhone]);

        parent::setCompanyAllowContactViaPhone($companyAllowContactViaPhone);
    }
