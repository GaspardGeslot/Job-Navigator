...
export default {
  ...
  setup(props) {
    const http = new APIService(
      ...
      `/${window.appGlobal.theme}/api/v2/pim/employees/${props.employeeId}/custom-fields?screen=${props.screen}`,
    );
  ...
  methods: {
    onSave() {
      ...
      this.http
        .request({
          method: 'PUT',
          url: `/${window.appGlobal.theme}/api/v2/pim/employees/${this.employeeId}/custom-fields`,
