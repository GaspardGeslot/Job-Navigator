...
import QuickLaunchWidget from '../components/QuickLaunchWidget.vue';
import BuzzLatestPostWidget from '../components/BuzzLatestPostWidget.vue';
import EmployeeSubunitWidget from '../components/EmployeeSubunitWidget.vue';
import MyActionSummaryWidget from '../components/MyActionSummaryWidget.vue';
import EmployeeLocationWidget from '../components/EmployeeLocationWidget.vue';
import EmployeesOnLeaveWidget from '../components/EmployeesOnLeaveWidget.vue';
import EmployeeAttendanceWidget from '../components/EmployeeAttendanceWidget.vue';
