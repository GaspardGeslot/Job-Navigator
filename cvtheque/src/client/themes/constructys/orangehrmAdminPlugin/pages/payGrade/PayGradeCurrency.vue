...
<script>
import InlineActionButton from '../../components/InlineActionButton.vue';
import {APIService} from '@/core/util/services/api.service';
import usePaginate from '@/core/util/composable/usePaginate';
import SavePayCurrency from '../payGrade/SavePayCurrency.vue';
import EditPayCurrency from '../payGrade/EditPayCurrency.vue';
