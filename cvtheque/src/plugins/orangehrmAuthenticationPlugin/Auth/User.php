...
class User
{
     ...
     * @return string|null
     */
    public function getUserHedwigeToken(): ?string
    {
        return $this->getAttribute(self::USER_HEDWIGE_TOKEN);
    }
     ...
     * @internal
     */
    public function setUserHedwigeToken(?string $token): void
    {
        $this->setAttribute(self::USER_HEDWIGE_TOKEN, $token);
    }
